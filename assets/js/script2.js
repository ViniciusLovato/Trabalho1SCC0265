(function ($) {
    $.fn.tooltip = function (options) {
      ...
      return this.each(
			...
			if (origin.attr('hover-tooltip') === "true" || !origin.attr('hover-tooltip')) {//if "hover-tooltip" is true or the attribute doesn't exist or is === "", then go for normal behaviour
				$(this).on({
					mouseenter: show,
					mouseleave: hide
				});
